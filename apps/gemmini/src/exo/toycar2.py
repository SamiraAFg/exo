...
def test_matmul_toycar_1_8_128():
    ...
    cpu = rename(
        matmul_algorithm(), "cpu_exo_toycar_layer_1_8_128"
    )  # Rename "matmul" to "matmul_on_cpu"
    cpu = cpu.partial_eval(K=KK, N=NN, M=MM)

    # Rename the procedure to "matmul_on_gemmini"
    gemmini = rename(cpu, "exo_toycar_layer_1_8_128")
...
# --- Toycar tests ---
cpu_exo_toycar_layer_1_128_640, exo_toycar_layer_1_128_640 = test_matmul_toycar(
    1, 128, 640
)
# cpu_exo_toycar_layer_1_128_128, exo_toycar_layer_1_128_128 = test_matmul_toycar(1, 128, 128)
# cpu_exo_toycar_layer_1_8_128, exo_toycar_layer_1_8_128 = test_matmul_toycar_1_8_128()
# cpu_exo_toycar_layer_1_128_8, exo_toycar_layer_1_128_8 = test_matmul_toycar(1, 128, 8)
# cpu_exo_toycar_layer_1_128_8, exo_toycar_layer_1_128_8 = test_matmul_toycar(1, 640, 128)
