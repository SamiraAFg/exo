...
# def make_do_ld_i8_block(name, instr_str, p=ld_i8_block_new):
#     p = rename(p, name)
...
# )
# do_ld_i8_block_id2_new = make_do_ld_i8_block("do_ld_i8_block_id2", _do_gemm_ld_i8_block_id2_new)
...
# def make_ld_i8_block_new(name, ld_id, p=ld_i8_block, stride_val=None):
#     if ld_id == 2:
