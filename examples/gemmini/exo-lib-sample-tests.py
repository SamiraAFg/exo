...
def test_matmul(NN, MM):
    ...
    perm_vector_b = [0, 3, 1, 4, 2] if NN == 1024 else [2, 0, 3, 1]
    perm_vector_a = [0, 1, 3, 2, 4] if MM == 1024 else [0, 2, 1, 3]
    # Fix indexing
    gemmini = rearrange_dim(gemmini, a_alloc, perm_vector_a)
    gemmini = rearrange_dim(gemmini, b_alloc, perm_vector_b)
...
test_matmul(1024, 256)
# test_matmul(512, 512)
# test_matmul(256, 1024)
