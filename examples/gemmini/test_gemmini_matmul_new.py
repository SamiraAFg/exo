...
def test_matmul():
    ...
    # print("gemmini after rearranging a_alloc")
    # print(gemmini)
    # gemmini = rearrange_dim(gemmini, b_alloc, [1, 2, 0])
    gemmini = rearrange_dim(gemmini, a_alloc, [0, 2, 1, 3])
    gemmini = rearrange_dim(gemmini, b_alloc, [2, 0, 3, 1])
    gemmini = reorder_loops_from_idx(gemmini, a_load)
    gemmini = reorder_loops_from_idx(gemmini, b_load)
    ...
    # print(gemmini)
    # print("instructions tuples")
    # print(zero_acc_i32)
    # print("*"*30)
    # print(zero_acc_i32_v2)
    # print("*"*30)
    # print(ld_i8_block_id1)
    # print("*"*30)
    # print(ld_i8_block_id1_v2)
    # print("*"*30)
    # print(ld_acc_i32_vector)
    # print("*"*30)
    # print(ld_acc_i32_vector_v2)
    tuples = [
        (zero_acc_i32, zero_acc_i32_v2),
        (ld_i8_block_id1, ld_i8_block_id1_v2),
        (ld_i8_block_id2, ld_i8_block_id2_v2),
